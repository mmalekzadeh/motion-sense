...
## Citation
  If you use this dataset, please must cite the following paper:
  * **Mohammad Malekzadeh, Richard G. Clegg, Andrea Cavallaro, Hamed Haddadi.[Protecting Sensory Data against Sensitive Inferences](https://arxiv.org/abs/1802.07802). In Proceedings of the 1st EuroSys Workshop on Privacy by Design in Distributed Systems (W-P2DS 2018), April 23, 2018, Porto, Portugal (to appear).**
